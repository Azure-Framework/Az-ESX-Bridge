# ESX Legacy compatibility bridge

ESX Legacy compatibility bridge lets resources written for another framework talk to Az-Framework without rewriting the whole resource stack.
