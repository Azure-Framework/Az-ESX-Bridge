# Az-ESX-Bridge for Az-Framework

Az-ESX-Bridge is an Az-Framework compatibility bridge. It provides the expected resource name and API surface for resources written around QBCore, qb-inventory, qb-target, ESX, or ND_Core.
